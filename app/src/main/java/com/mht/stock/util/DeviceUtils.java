...
public class DeviceUtils {
    ...
    public static String getAndroidID() {
        return Settings.Secure.getString(MyApplication.getApplication().getContentResolver(), Settings.Secure.ANDROID_ID);
    }
    ...
    public static void reboot(String reason) {
        PowerManager mPowerManager = (PowerManager) MyApplication.getApplication().getSystemService(Context.POWER_SERVICE);
        try {
